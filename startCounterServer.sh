...
#  	ttab -t 'R0' runscripts/smartrun.sh bftsmart.demo.counter.CounterServer $((id)) /Users/royshadmon/BFT-SMART/config/hosts.config /Users/royshadmon/BFT-SMART/src/main/java/bftsmart/demo/counter/layerConfigs/layer2.properties
  ttab -t 'R0' runscripts/smartrun.sh bftsmart.demo.counter.CounterServer $((id)) /Users/royshadmon/BFT-SMART/src/main/java/bftsmart/demo/counter/layerConfigs/layer1.properties
	count=$((count+1))
	echo $id
...
do
	echo "Starting layer 1 replica $id"
  	ttab -t 'R0' runscripts/smartrun.sh bftsmart.demo.counter.CounterServer $((id)) /Users/royshadmon/BFT-SMART/src/main/java/bftsmart/demo/counter/layerConfigs/layer2.properties
	echo $id
